...
final ticketEventsProvider = FutureProvider.family<List<TicketDetail>, String>((ref, search) {
  return ref.watch(userApiProvider).fetchTicketEvents(search: search.isEmpty ? null : search);
});

class _SelfTicketingScreenState extends ConsumerState<SelfTicketingScreen> {
  String _search = '';
  static const List<String> _filters = ['Tonight', 'This week', 'Under 300'];

  @override
  Widget build(BuildContext context) {
    final colorScheme = Theme.of(context).colorScheme;
    final eventsAsync = ref.watch(ticketEventsProvider(_search));
    return Scaffold(
      appBar: AppBar(
