...
class _TicketDetailScreenState extends ConsumerState<TicketDetailScreen> {
                  ...
                  .map(
                    (entry) => GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: entry.key == _selectedTierIndex
                              ? const Color(0xFFFFFBEB)
                              : const Color(0xFFF8FAFC),
                          borderRadius: BorderRadius.circular(14),
                          border: Border.all(
                            color: entry.key == _selectedTierIndex ? const Color(0xFFF59E0B) : const Color(0xFFE5E7EB),
                          ),
                        ),
                        child: Row(
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 4),
                                  Text('${entry.value.available} available',
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '₹${entry.value.mrp.toStringAsFixed(0)}',
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text('Rating ${ticket.sellerRating}', style: const TextStyle(fontSize: 12, color: Colors.black54)),
                    ],
                  ),
                ),
  ...
  Future<void> _buyTicket(TicketDetail ticket) async {
    ...
    final tier = ticket.tickets[_selectedTierIndex];
    try {
      await ref.read(userApiProvider).createTicketOrder(
            eventId: ticket.id,
